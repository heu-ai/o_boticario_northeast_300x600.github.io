...
function APICall(n){
  ...
  fetch('https://demo.infuseads.com:8081/core/key-count/?id=57', {
    method: 'POST',
    body: x,
    headers: {
...
function pg2func(op){
    ...
    btn1.style = "position: absolute;top: 285px;left: 19px;height: 75px;background: transparent;width: 277px;border-radius: 15%;border: 1px solid transparent;";
    ...
    btn2.style = "position: absolute;top: 381px;left: 19px;height: 75px;background: transparent;width: 277px;border-radius: 15%;border: 1px solid transparent;";
